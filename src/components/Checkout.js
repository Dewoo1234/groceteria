...
const Checkout = () => {
  ...
  const GetAddress = () => {
    const url = `http://localhost:2020/getAddressByUserId/${id}`
  ...
  const UserCart = () => {
    const url = `http://localhost:2020/getCartByUserId/${id}`
  ...
  const addToOrders = () => {
    ...
    const url2 = `http://localhost:2020/addToOrders`
  ...
  const addToOrderDetails = () => {
    ...
    cartProducts.map((element) => {
      ...
      const url3 = `http://localhost:2020/addToOrderDetails`
  ...
  const updateCartOrderDeatails = () => {
    ...
    // cart empty
    const url1 = `http://localhost:2020/deleteCartByCustomerId/${id}`
